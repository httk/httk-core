...
def test_related_entry_defaults_and_equality() -> None:
    ...
    grouped = RelatedEntry("files", "f-1", relationship="has_input")
    assert grouped == RelatedEntry("files", "f-1", relationship="has_input")
    assert grouped != RelatedEntry("files", "f-1")
    assert grouped != RelatedEntry("files", "f-1", relationship="has_output")
